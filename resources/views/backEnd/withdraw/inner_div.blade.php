                    ...
                    <tbody>
                        @foreach ($withdrawRequest as $key => $item)
                            <tr>
                                ...
                                <td><span class="badge badge-success p-2">{{ $item->paymentMethod->method_name }}</span>
                                </td>
                                <td>
                                    @if ($item->status == 1)
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-success action-icon" data-toggle="modal"
                                        data-target="#showAppointmentModal{{ $item->id }}"><i
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" id="modalSize">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="showDetaildModalTile">Approve Withdraw
                                                    Request</h4>
                                                </h4>
                                            ...
                                            <div class="modal-body" id="showDetaildModalBody">
                                                ...
                                                <input type="hidden" name="id" class="url"
                                                    value="{{ $item->id }}">
