                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                            <div class="">
                                ...
                                <p class="">Please insert your new password here</p>
                            </div>
                            <form action="{{url('reset-password')}}" method="post">
                                <div class="form-group first mb-3">
                                    <label for="username1">Password</label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="username1" required="required" />
                                ...
                                <div class="form-group first mb-3">
                                    <label for="username1">Password Confirm</label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"  name="password_confirmation" id="username1" required="required" />
                                </div>
