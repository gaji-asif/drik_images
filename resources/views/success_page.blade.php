      ...
      <div class="card mb-2">
        <section class="c-container">
          ...
          <div class="text-center">
            <h3 class="h3tag"><strong>Success!</strong></h3>

            <div class="progress">
              <div class="progress-bar o-circle__sign--success"  role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <hr>
            <h6 class="message h6tag">Thank you.You've completed payment successfully.Goto <a style="color:  rgb(56, 176, 131)" href="{{route('your-dashboard')}}">Dashboard</a></h6> 
          </div>
