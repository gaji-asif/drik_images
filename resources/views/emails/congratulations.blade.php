                                                                                        ...
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 22px; color: #464646;"
                                                                                                    ...
                                                                                                    align="left">
                                                                                                    <a href="#"
                                                                                                        style="text-decoration: none; color: #464646;">Congratulations</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;"
                                                                                                    align="left">
                                                                                                     Dear, {{$body}}.
                                                                                                     <br>
                                                                                                     Drik Images Team has approved you as a contributor. Now your can start contributing to the platform.
                                                                                                     <br>
                                                                                                     <br>
                                                                                                     Thank you,
